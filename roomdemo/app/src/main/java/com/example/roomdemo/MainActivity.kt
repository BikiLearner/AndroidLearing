...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val employeeDao=(application as EmpolyeeApp).db.empolyeeDao()
    ...
    fun addRecord(employeeDao:EmpolyeeDao){
        ...
        if(email.isNotEmpty() && name.isNotEmpty()){
            ...
            Toast.makeText(applicationContext,"Email and name is blank",Toast.LENGTH_LONG).show()
        }
    }
    fun updateRecordDialog(id:Int,employeeDao:EmpolyeeDao)  {
    ...
    private fun deleteRecordAlertDialog(id:Int, employeeDao: EmpolyeeDao, employee: EmployeeEntity) {
